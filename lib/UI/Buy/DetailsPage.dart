...
class DetailsPage extends StatefulWidget {
  final title, img;
  DetailsPage(this.title, this.img, {Key? key}) : super(key: key);
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: Text("Category: Popular",
                      style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Wrap(
                        children: <Widget>[
                          Text(
                            "In our application there are different types of popular plants can be seen. They make the environment calm and keeps it pleasant.",
                            style: TextStyle(
                              color: Colors.grey,
                              fontWeight: FontWeight.w600,
                            ),
