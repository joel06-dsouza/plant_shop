...
class DetailsPage3 extends StatefulWidget {
  final title, img;
  DetailsPage3(this.title, this.img, {Key? key}) : super(key: key);

  @override
  _DetailsPage3State createState() => _DetailsPage3State(this.title, this.img);
}

class _DetailsPage3State extends State<DetailsPage3> {
  String title, img;
  _DetailsPage3State(this.title, this.img);
  @override
